...
function authMailTemplate(userGreeting, infoText, code) { 
                                ...
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;" align="left" bgcolor="#ffffff">
                                    ...
                                    <table class="btn btn-primary p-3 fw-700" role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-radius: 6px; border-collapse: separate !important; font-weight: 700 !important;">
                                      <tbody>
                                        <tr>
                                          <td style=" font-weight: 700 !important; margin: 0; display:block;">
                                            <div style="color: #000 font-size: 59px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; display: block; font-weight: 700 !important; white-space: nowrap;letter-spacing:10px;">${code}</div>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
